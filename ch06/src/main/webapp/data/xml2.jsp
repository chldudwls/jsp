...
try{
	...
	for(User2VO vo : users ){
		...
		Element eAddr = new Element("addr");
		
		
		eUser.setText(vo.getUid());
		eUser.setText(vo.getName());
		eUser.setText(vo.getBirth());
		eUser.setText(vo.getClass());
		eUser.setText(vo.getAddr());
		
		doc.addContent(eUsers);
	}
