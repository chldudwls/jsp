...
<head>
    ...
    <style>
        ...
        * 
        ...
        .sideimage .greet img:nth-child(1) { top: 26px; } 
        .sideimage .way img:nth-child(1) { top: 61px;}
    ...
    <main>
        ...
        <section>
            <aside>
                ...
                <div class="sideimage">
                    <img src="../images/sub_aside_bg_lnb.png"  alt="사이드 배경">
                    <a href="./introduction.html" class="greet">
                    <img src="../images/sub_cate1_lnb1.png" alt="1">
                    </a>
                    <a href="./direction.html" class="way">
            ...
            <article>
                <nav class="articleNav">
                    ...
                    <p><img src="../images/sub_page_nav_ico.gif" alt="navIcon"> HOME > 팜스토리소개 > <strong>찾아오시는 길</strong></p>
                  </nav>
                <div>
                    
                    <p>팜스토리</p>
                    <p>주소 : 경기도 이천시 잘한다구 신난다동 123<br>
                        전화 : 01-234-5678
                    </p>
                    <p>찾아오시는 길</p>
                </div>
