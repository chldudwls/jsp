...
<head>
<meta charset="UTF-8">
<title>2.JSPLTest</title>
<!-- 
		날짜 : 2024-08-13
		이름 : 최영진
		내용 : JSPL(Java Standards Tag Library) 실습하기
-->
</head>
<body>
	<h3>2.JSPL</h3>
	...
	<%
		...
		//조건문
		if(num1 < num2){
			out.print("<p>num1은num2보다 작다</p>");
		}
		
		if(num1 > num2){
			out.print("<p>num1은num2보다 크다</p>");
		}else{
			out.print("<p>num1은num2보다 작다</p>");
		}
	...
	<p>문자열 교페 : ${f:replace(hello, "world","korea")}</p>
	<p>문자열  : ${f:indexOf(hello, "e")}</p>
